...
# include <openssl/openssl/macros.h>
# ifndef OPENSSL_NO_DEPRECATED_3_0
#  define HEADER_SAFESTACK_H
# endif

// # include <openssl/stack.h>
# include <openssl/openssl/stack.h>
// # include <openssl/e_os2.h>
# include <openssl/openssl/e_os2.h>
...
# define DEFINE_SPECIAL_STACK_OF_CONST(t1, t2) \
	...
	/*
// TODO: this is new, taken from perl script to replicate 'generate_stack_macros' function
# define GENERATE_STACK_MACROS_INT(nametype, realtype, plaintype) \
...
# define GENERATE_STACK_MACROS(t) GENERATE_STACK_MACROS_INT(t, t, t)
*/
